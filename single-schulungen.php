...
<?php
    ...
    $datum = get_field_object('schulung-datum');
    $teilnehmer = get_field_object('schulung-teilnehmer');
    $ort = get_field_object('schulung-ort');
    $kanton = get_field_object('schulung-kanton');
    $kursnummer = get_field_object('schulung-nummer');
    $anmeldeschluss = get_field_object('schulung-anmeldeschluss');
    $verantwortlich = get_field_object('schulung-verantwortlich');
    $pdf = get_field_object('schulung-pdf');
    $voraussetzungen = get_field_object('schulung-voraussetzungen');
    $mitbringen = get_field_object('schulung-mitbringen');
    $kosten = get_field_object('schulung-kosten');
					...
					<div class="wpbf-article-wrapper">
                        ...
                        <section class="entry-content article-content" itemprop="text">
                            ...
                            <div class="wpbf-grid">
                                ...
                                <?php if (have_rows('schulung-teilnehmer')): ?>
                                    <div class="wpbf-small-1-3 teilnehmer-wrapper">
                                        <div class="wpbf-post-style-boxed">
                                            <h2><?php echo $teilnehmer['label']; ?></h2>
                                            <?php while (have_rows('schulung-teilnehmer')): the_row(); ?>
                                                <?php
                                                $begrenzung = get_sub_field('schulung-teilnehmer-begrenzung');
                                                $min = get_sub_field_object('schulung-teilnehmer-minimum');
                                                $max = get_sub_field_object('schulung-teilnehmer-maximum');
                                                ?>
                                                <p>
                                                    <?php if ($begrenzung) : ?>
                                                        <?php if ($min['value']) : ?>
