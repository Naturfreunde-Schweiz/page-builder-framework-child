...
<?php
    ...
    $kursnummer = get_field_object('kurs-nummer');
    $datum = get_field_object('kurs-datum');
    $ort = get_field_object('kurs-ort');
    $kanton = get_field_object('kurs-kanton');
    $teilnehmer = get_field_object('kurs-teilnehmer');
    $anmeldeschluss = get_field_object('kurs-anmeldeschluss');
    $pdf = get_field_object('kurs-pdf');
    $ninjaform = get_field('anmeldeformular_shortcode');

    $verantwortlich = get_field_object('kurs-verantwortlich');
    $voraussetzungen = get_field_object('kurs-voraussetzungen');
    $ziele = get_field_object('kurs-ziele');
    $mitbringen = get_field_object('kurs-mitbringen');
    $versicherung = get_field_object('kurs-versicherung');

    $kosten = get_field_object('kurs-kosten');
    $kosten_beteiligung = get_field_object('kurs-kostenbeteiligung');
?>
...
<div id="content">
	...
	<?php wpbf_inner_content(); ?>
        ...
        <div class="logo-wrapper">
            <?php if ($zielgruppen[0] -> name == "esa-Leiter") { ?>
                <img class="wp-image-10641" alt="Logo Erwachsenensport esa" src="/wp-content/uploads/2fcmyk_de-300x130.jpg" />
            <?php } else if ($zielgruppen[0] -> name == "J+S-Leiter") { ?>
                <img class="wp-image-10643" alt="Logo Jugend + Sport J+S" src="/wp-content/uploads/JS_d_f_RGB-294x300.jpg" />
            <?php } ?>
        </div>
					...
					<div class="wpbf-article-wrapper">
                        ...
                        <section class="entry-content article-content" itemprop="text">
                            ...
                            <div class="wpbf-grid">
                                ...
                                <?php if (have_rows('kurs-teilnehmer')) : ?>
                                    <div class="wpbf-small-1-3 teilnehmer-wrapper">
                                        <div class="wpbf-post-style-boxed">
                                            <h2><?php echo $teilnehmer['label']; ?></h2>
                                            <?php while (have_rows('kurs-teilnehmer')) : the_row(); ?>
                                                <?php
                                                $begrenzung = get_sub_field('kurs-teilnehmer-begrenzung');
                                                $min = get_sub_field_object('kurs-teilnehmer-minimum');
                                                $max = get_sub_field_object('kurs-teilnehmer-maximum');
                                                ?>
                                                <p>
                                                    <?php if ($begrenzung) : ?>
                                                        <?php if ($min['value']) : ?>
                                ...
                                <div class="wpbf-small-1-2">
                                    <table class="wpbf-table">
                                        ...
                                        <?php if ($zielgruppen) : ?>
                                            <tr>
                                                <th><?php echo _e('Zielgruppe', 'page-builder-framework-child'); ?></th>
                                                <td><?php echo $zielgruppen[0]->name; ?></td>
                                            </tr>
                                        <?php endif; ?>
                                    </table>
                                </div>
                            ...
                            <div class="wpbf-1-1 weitere-informationen-wrapper">
                                ...
                                <div class="wpbf-grid">
                                    ...
                                    <?php if ($ziele['value']) : ?>
                                        <div class="wpbf-small-1-2">
                                            <h3><?php echo $ziele['label']; ?></h3>
                                            <p><?php echo $ziele['value']; ?></p>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if ($kosten['value']) : ?>
                                        <div class="wpbf-small-1-2">
                                            ...
                                            <?php if (strpos(get_the_title(), 'Teil')) : ?>
                                                <p><?php echo $kosten['value']; ?> <?php echo $kosten['prepend'] . __(' (für beide Teile des Kurses)', 'page-builder-framework-child'); ?>, <strong id=kostenbeteiligungcss><?php echo __('NF-Mitglieder erhalten eine Kostenbeteiligung von', 'page-builder-framework-child') ?> <?php echo $kosten_beteiligung['value']; ?> <?php echo $kosten_beteiligung['prepend']; ?></strong></p>
                                            <?php else : ?>
                                                <p><?php echo $kosten['value']; ?> <?php echo $kosten['prepend']; ?>, <strong id=kostenbeteiligungcss><?php echo __('NF-Mitglieder erhalten eine Kostenbeteiligung von', 'page-builder-framework-child') ?> <?php echo $kosten_beteiligung['value']; ?> <?php echo $kosten_beteiligung['prepend']; ?></strong></p>
                                            <?php endif; ?>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            ...
                            <?php if ($status['value']['value'] != 'abgesagt' && $ninjaform) : ?>
                                ...
                                <div class="wpbf-1-1" id="nfs-ninja_form">
